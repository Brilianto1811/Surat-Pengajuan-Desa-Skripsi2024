<div id="form-keterangan-usaha">
    ...
    <div class="intro-y mt-5 col-span-12 lg:col-span-6">
        ...
        <div class="intro-y box p-5">
            ...
            @endphp
            <form id="createFormKeteranganUsaha" action="{{ route($url_form_action) }}" method="POST">
                @csrf
                ...
                <div class="card p-4 mb-4" style="background-color: #9fa8b3; color: black; border-radius: 10px">
                    ...
                    <div class="card-body">
                        <div class="grid grid-cols-2 gap-4 mt-3">
                            <!-- NO KK -->
                            <div>
                                <x-base.form-label for="crud-form-7">NO KK <span
                                        class="text-red-500">*</span></x-base.form-label>
                                <x-base.form-input class="w-full" id="crud-form-7" type="text" placeholder="NO KK"
                                    name="no_kk" value="{{ $form_no_kk }}" required />
                            </div>

                            <!-- Kepala KK -->
                            <div>
                                <x-base.form-label for="crud-form-8">Kepala KK <span
                                        class="text-red-500">*</span></x-base.form-label>
                            ...
                            <!-- Tempat Tinggal -->
                            <div>
                                <x-base.form-label for="crud-form-15">Tempat Tinggal <span
                                        class="text-red-500">*</span></x-base.form-label>
                                <x-base.form-input class="w-full" id="crud-form-15" type="text"
                                    placeholder="Tempat Tinggal" name="alamat" value="{{ $form_alamat }}" required />
                            </div>

                            <!-- Kelurahan -->
                            <div>
                                <x-base.form-label for="form-kel-keterangan-usaha">Kelurahan/Desa <span
                                        class="text-red-500">*</span></x-base.form-label>
                                <x-base.form-select class="sm:mr-2" id="form-kel-keterangan-usaha" aria-label="Surat"
                            ...
                            <!-- Kecamatan -->
                            <div>
                                <x-base.form-label for="form-kec-keterangan-usaha">Kecamatan <span
                                        class="text-red-500">*</span></x-base.form-label>
                                <x-base.form-select class="sm:mr-2" id="form-kec-keterangan-usaha" aria-label="Surat"
                            ...
                            <!-- Status Perkawinan -->
                            <div>
                                <x-base.form-label for="crud-form-4">Status <span
                                        class="text-red-500">*</span></x-base.form-label>
                                <x-base.form-select class="w-full" id="crud-form-4" name="status" required>
                            ...
                            <!-- Pekerjaan -->
                            <div>
                                <x-base.form-label for="crud-form-14">Pekerjaan <span
                                        class="text-red-500">*</span></x-base.form-label>
                            ...
                            <!-- Pendidikan -->
                            <div>
                                <x-base.form-label for="crud-form-13">Pendidikan <span
                                        class="text-red-500">*</span></x-base.form-label>
                ...
                <div class="card p-4 mb-4 mt-3" style="background-color: #bec0c3; color: black; border-radius: 10px">
                    ...
                    <div class="card-body mt-3">
                        <div class="grid grid-cols-2 gap-4 mt-3">
                            <!-- Nama Usaha -->
                            <div>
                                <x-base.form-label for="crud-form-12">Nama Usaha <span
                                        class="text-red-500">*</span></x-base.form-label>
                ...
                <div class="mt-5 text-right">
                    ...
                    <x-base.button id="save-button-ket-usaha" class="w-24 text-white" type="button"
                        variant="success">
                        Simpan
                    </x-base.button>
                </div>
...
<div id="confirmation-modal-ket-usaha" aria-hidden="true" tabindex="-1"
    ...
    <div
        ...
        <div class="px-5 pb-8 text-center flex justify-center space-x-2">
            <x-base.button id="cancel-button-ket-usaha" class="w-full px-4 py-3" variant="soft-dark" type="button">
                Periksa Kembali
            </x-base.button>
            <x-base.button id="confirm-button-ket-usaha" class="w-full px-4 py-3 text-white" variant="success"
                type="button">
                Simpan
            </x-base.button>
        </div>
...
<script>
    function clearForm() {
        ...
        document.getElementById('crud-form-14').value = '';
        document.getElementById('crud-form-15').value = '';
        // Lanjutkan dengan field form lainnya sesuai dengan id masing-masing
    }

    const formSelectKecKeteranganUsaha = document.getElementById('form-kec-keterangan-usaha')
    const formSelectKelKeteranganUsaha = document.getElementById('form-kel-keterangan-usaha')

    formSelectKecKeteranganUsaha.addEventListener("change", function() {
        var selectedKec = this.value; // Get the value of the selected kecamatan
        var kelOptions = document.querySelectorAll(
            "#form-kel-keterangan-usaha option.data-kel"); // Select all options in kelurahan
        ...
        formSelectKelKeteranganUsaha.value = ''
        formSelectKelKeteranganUsaha.dispatchEvent(new Event('change'));
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (isadmin != 'true') {
            console.log('keganti')
            formSelectKecKeteranganUsaha.value = `{{ $user->id_kec }}`;
            formSelectKecKeteranganUsaha.dispatchEvent(new Event('change'));
            formSelectKelKeteranganUsaha.value = `{{ $user->id_kel }}`;
            formSelectKelKeteranganUsaha.dispatchEvent(new Event('change'));
        }
    })

    document.getElementById('save-button-ket-usaha').addEventListener('click', function(event) {
        event.preventDefault(); // Prevent the form from submitting

        const form = document.getElementById('createFormKeteranganUsaha');

        if (form.checkValidity()) {
            // Form is valid, show the modal
            const modal = document.getElementById('confirmation-modal-ket-usaha');
    ...
    document.getElementById('cancel-button-ket-usaha').addEventListener('click', function() {
        const modal = document.getElementById('confirmation-modal-ket-usaha');
    ...
    document.getElementById('confirm-button-ket-usaha').addEventListener('click', function() {
        document.getElementById('createFormKeteranganUsaha').submit(); // Submit the form
    });
</script>
