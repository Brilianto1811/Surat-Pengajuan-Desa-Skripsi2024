<div id="form-izin-keramaian">
    ...
    <div class="intro-y mt-5 col-span-12 lg:col-span-6">
        ...
        <div class="intro-y box p-5">
            ...
            @endphp
            <form id="createFormIzinKeramaian" action="{{ route($url_form_action) }}" method="POST">
                @csrf
                ...
                @php
                    ...
                    $form_form_jenis_keramaian = ''; // INI BUAT CONTOH YANG BELUM ADA VALUENYA
                ...
                <div class="card p-4 mb-4" style="background-color: #9fa8b3; color: black; border-radius: 10px">
                    ...
                    <div class="card-body">
                        <div class="grid grid-cols-2 gap-4 mt-3">
                            ...
                            <!-- Kelurahan -->
                            <div>
                                <x-base.form-label for="form-kel-izin-keramaian">Kelurahan/Desa <span
                                        class="text-red-500">*</span></x-base.form-label>
                                <x-base.form-select class="sm:mr-2" id="form-kel-izin-keramaian" aria-label="Surat"
                            ...
                            <!-- Kecamatan -->
                            <div>
                                <x-base.form-label for="form-kec-izin-keramaian">Kecamatan <span
                                        class="text-red-500">*</span></x-base.form-label>
                                <x-base.form-select class="sm:mr-2" id="form-kec-izin-keramaian" aria-label="Surat"
                ...
                <div class="card p-4 mb-4 mt-3" style="background-color: #bec0c3; color: black; border-radius: 10px">
                    ...
                    <div class="card-body">
                        <div class="grid grid-cols-2 gap-4 mt-3">
                            <!-- Jenis Keramaian -->
                            <div>
                                <x-base.form-label for="crud-form-12">Jenis Keramaian <span
                                        class="text-red-500">*</span></x-base.form-label>
                                <x-base.form-input class="w-full" id="crud-form-12" type="text"
                                    placeholder="Jenis Keramaian" name="form_jenis_keramaian"
                                    value="{{ $form_form_jenis_keramaian }}" required />
                            </div>
                ...
                <div class="mt-5 text-right">
                    ...
                    <x-base.button id="save-button-izin-keramaian" class="w-24 text-white" type="button"
                        variant="success">
                        Simpan
                    </x-base.button>
                </div>
...
<div id="confirmation-modal-izin-keramaian" aria-hidden="true" tabindex="-1"
    ...
    <div
        ...
        <div class="px-5 pb-8 text-center flex justify-center space-x-2">
            <x-base.button id="cancel-button-izin-keramaian" class="w-full px-4 py-3" variant="soft-dark"
                type="button">
                Periksa Kembali
            </x-base.button>
            <x-base.button id="confirm-button-izin-keramaian" class="w-full px-4 py-3 text-white" variant="success"
                type="button">
                Simpan
            </x-base.button>
        </div>
...
<script>
    ...
    const formSelectKecIzinKeramaian = document.getElementById('form-kec-izin-keramaian')
    const formSelectKelIzinKeramaian = document.getElementById('form-kel-izin-keramaian')

    formSelectKecIzinKeramaian.addEventListener("change", function() {
        var selectedKec = this.value; // Get the value of the selected kecamatan
        var kelOptions = document.querySelectorAll(
            "#form-kel-izin-keramaian option.data-kel"); // Select all options in kelurahan
        ...
        formSelectKelIzinKeramaian.value = ''
        formSelectKelIzinKeramaian.dispatchEvent(new Event('change'));
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (isadmin != 'true') {
            console.log('keganti')
            formSelectKecIzinKeramaian.value = `{{ $user->id_kec }}`;
            formSelectKecIzinKeramaian.dispatchEvent(new Event('change'));
            formSelectKelIzinKeramaian.value = `{{ $user->id_kel }}`;
            formSelectKelIzinKeramaian.dispatchEvent(new Event('change'));
        }
    })

    document.getElementById('save-button-izin-keramaian').addEventListener('click', function(event) {
        event.preventDefault(); // Prevent the form from submitting

        const form = document.getElementById('createFormIzinKeramaian');

        if (form.checkValidity()) {
            // Form is valid, show the modal
            const modal = document.getElementById('confirmation-modal-izin-keramaian');
    ...
    document.getElementById('cancel-button-izin-keramaian').addEventListener('click', function() {
        const modal = document.getElementById('confirmation-modal-izin-keramaian');
    ...
    document.getElementById('confirm-button-izin-keramaian').addEventListener('click', function() {
        document.getElementById('createFormIzinKeramaian').submit(); // Submit the form
    });
</script>
