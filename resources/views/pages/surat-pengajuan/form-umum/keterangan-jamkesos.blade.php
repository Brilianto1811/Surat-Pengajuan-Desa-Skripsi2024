<div id="form-keterangan-jamkesos">
    @isset($suratEdit)
    @endisset
    <div class="intro-y mt-5 col-span-12 lg:col-span-6">
        ...
        <div class="intro-y box p-5">
            ...
            @endphp
            <form id="createFormKeteranganJamkesos" action="{{ route($url_form_action) }}" method="POST">
                @csrf
                ...
                @php
                    ...
                    $form_form_no_jamkesos = ''; // INI BUAT CONTOH YANG BELUM ADA VALUENYA
                    ...
                    if (isset($suratEdit)) {
                        ...
                        $form_form_no_jamkesos = $suratEdit->form_no_jamkesos;
                ...
                <div class="card p-4 mb-4" style="background-color: #9fa8b3; color: black; border-radius: 10px">
                    ...
                    <div class="card-body">
                        <div class="grid grid-cols-2 gap-4 mt-3">
                            ...
                            <!-- Tanggal Lahir -->
                            <div>
                                <x-base.form-label for="crud-form-7">Tanggal Lahir <span
                                        class="text-red-500">*</span></x-base.form-label>
                                <x-base.litepicker class="w-full" id="crud-form-7" placeholder="Tanggal Lahir"
                            ...
                            <!-- Kelurahan -->
                            <div>
                                <x-base.form-label for="form-kel-keterangan-jamkesos">Kelurahan/Desa <span
                                        class="text-red-500">*</span></x-base.form-label>
                                <x-base.form-select class="sm:mr-2" id="form-kel-keterangan-jamkesos" aria-label="Surat"
                            ...
                            <!-- Kecamatan -->
                            <div>
                                <x-base.form-label for="form-kec-keterangan-jamkesos">Kecamatan <span
                                        class="text-red-500">*</span></x-base.form-label>
                                <x-base.form-select class="sm:mr-2" id="form-kec-keterangan-jamkesos" aria-label="Surat"
                ...
                <div class="card p-4 mb-4 mt-3" style="background-color: #bec0c3; color: black; border-radius: 10px">
                    ...
                    <div class="card-body">
                        <div class="grid grid-cols-2 gap-4 mt-3">
                            <!-- NO Kartu Peserta JAMKESOS -->
                            <div>
                                <x-base.form-label for="crud-form-9">NO Kartu Peserta JAMKESOS <span
                                        class="text-red-500">*</span></x-base.form-label>
                                <x-base.form-input class="w-full" id="crud-form-9" type="text"
                                    placeholder="NO Kartu Peserta JAMKESOS" name="form_no_jamkesos"
                                    value="{{ $form_form_no_jamkesos }}" required />
                            </div>
                ...
                <div class="mt-5 text-right">
                    ...
                    <x-base.button id="save-button-jamkesos" class="w-24 text-white" type="button"
                        variant="success">
                        Simpan
                    </x-base.button>
                </div>
...
<div id="confirmation-modal-jamkesos" aria-hidden="true" tabindex="-1"
    ...
    <div
        ...
        <div class="px-5 pb-8 text-center flex justify-center space-x-2">
            <x-base.button id="cancel-button-jamkesos" class="w-full px-4 py-3" variant="soft-dark" type="button">
                Periksa Kembali
            </x-base.button>
            <x-base.button id="confirm-button-jamkesos" class="w-full px-4 py-3 text-white" variant="success"
                type="button">
                Simpan
            </x-base.button>
        </div>
...
<script>
    const formSelectKecKeteranganJamkesos = document.getElementById('form-kec-keterangan-jamkesos');
    const formSelectKelKeteranganJamkesos = document.getElementById('form-kel-keterangan-jamkesos');

    formSelectKecKeteranganJamkesos.addEventListener("change", function() {
        var selectedKec = this.value; // Get the value of the selected kecamatan
        var kelOptions = document.querySelectorAll(
            "#form-kel-keterangan-jamkesos option.data-kel"); // Select all options in kelurahan
        ...
        formSelectKelKeteranganJamkesos.value = ''
        formSelectKelKeteranganJamkesos.dispatchEvent(new Event('change'));
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (isadmin != 'true') {
            console.log('keganti')
            formSelectKecKeteranganJamkesos.value = `{{ $user->id_kec }}`;
            formSelectKecKeteranganJamkesos.dispatchEvent(new Event('change'));
            formSelectKelKeteranganJamkesos.value = `{{ $user->id_kel }}`;
            formSelectKelKeteranganJamkesos.dispatchEvent(new Event('change'));
        }
    });

    document.getElementById('save-button-jamkesos').addEventListener('click', function(event) {
        event.preventDefault(); // Prevent the form from submitting

        const form = document.getElementById('createFormKeteranganJamkesos');

        if (form.checkValidity()) {
            // Form is valid, show the modal
            const modal = document.getElementById('confirmation-modal-jamkesos');
    ...
    document.getElementById('cancel-button-jamkesos').addEventListener('click', function() {
        const modal = document.getElementById('confirmation-modal-jamkesos');
    ...
    document.getElementById('confirm-button-jamkesos').addEventListener('click', function() {
        document.getElementById('createFormKeteranganJamkesos').submit(); // Submit the form
    });
</script>
