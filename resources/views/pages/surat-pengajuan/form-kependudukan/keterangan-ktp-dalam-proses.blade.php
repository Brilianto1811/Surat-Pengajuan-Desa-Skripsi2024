<div id="form-keterangan-ktp-dalam-proses">
    @isset($suratEdit)
    @endisset
    <div class="intro-y mt-5 col-span-12 lg:col-span-6">
        ...
        <div class="intro-y box p-5">
            ...
            @endphp
            <form id="createFormKeteranganKTP" action="{{ route($url_form_action) }}" method="POST">
                @csrf
                ...
                <div class="card p-4 mb-4" style="background-color: #9fa8b3; color: black; border-radius: 10px">
                    ...
                    <div class="card-body">
                        <div class="grid grid-cols-2 gap-4 mt-3">
                            ...
                            <!-- Tanggal Lahir -->
                            <div>
                                <x-base.form-label for="crud-form-5">Tanggal Lahir <span
                                        class="text-red-500">*</span></x-base.form-label>
                                <x-base.litepicker class="w-full" id="crud-form-5" placeholder="Tanggal Lahir"
                            ...
                            <!-- Kelurahan -->
                            <div>
                                <x-base.form-label for="form-kel-keterangan-ktp-dalam-proses">Kelurahan/Desa <span
                                        class="text-red-500">*</span></x-base.form-label>
                                <x-base.form-select class="sm:mr-2" id="form-kel-keterangan-ktp-dalam-proses"
                            ...
                            <!-- Kecamatan -->
                            <div>
                                <x-base.form-label for="form-kec-keterangan-ktp-dalam-proses">Kecamatan <span
                                        class="text-red-500">*</span></x-base.form-label>
                                <x-base.form-select class="sm:mr-2" id="form-kec-keterangan-ktp-dalam-proses"
                            ...
                            <!-- Status Perkawinan -->
                            <div>
                                <x-base.form-label for="crud-form-8">Status Perkawinan <span
                                        class="text-red-500">*</span></x-base.form-label>
                ...
                <div class="mt-5 text-right">
                    ...
                    <x-base.button id="save-button-ket-ktp" class="w-24 text-white" type="button"
                        variant="success">
                        Simpan
                    </x-base.button>
                </div>
...
<div id="confirmation-modal-ket-ktp" aria-hidden="true" tabindex="-1"
    ...
    <div
        ...
        <div class="px-5 pb-8 text-center flex justify-center space-x-2">
            <x-base.button id="cancel-button-ket-ktp" class="w-full px-4 py-3" variant="soft-dark" type="button">
                Periksa Kembali
            </x-base.button>
            <x-base.button id="confirm-button-ket-ktp" class="w-full px-4 py-3 text-white" variant="success"
                type="button">
                Simpan
            </x-base.button>
        </div>
...
<script>
    ...
    const formSelectKecKeteranganKTP = document.getElementById('form-kec-keterangan-ktp-dalam-proses')
    const formSelectKelKeteranganKTP = document.getElementById('form-kel-keterangan-ktp-dalam-proses')

    formSelectKecKeteranganKTP.addEventListener("change", function() {
        var selectedKec = this.value; // Get the value of the selected kecamatan
        var kelOptions = document.querySelectorAll(
            "#form-kel-keterangan-ktp-dalam-proses option.data-kel"); // Select all options in kelurahan
        ...
        formSelectKelKeteranganKTP.value = ''
        formSelectKelKeteranganKTP.dispatchEvent(new Event('change'));
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (isadmin != 'true') {
            console.log('keganti')
            formSelectKecKeteranganKTP.value = `{{ $user->id_kec }}`;
            formSelectKecKeteranganKTP.dispatchEvent(new Event('change'));
            formSelectKelKeteranganKTP.value = `{{ $user->id_kel }}`;
            formSelectKelKeteranganKTP.dispatchEvent(new Event('change'));
        }
    })

    document.getElementById('save-button-ket-ktp').addEventListener('click', function(event) {
        event.preventDefault(); // Prevent the form from submitting

        const form = document.getElementById('createFormKeteranganKTP');

        if (form.checkValidity()) {
            // Form is valid, show the modal
            const modal = document.getElementById('confirmation-modal-ket-ktp');
    ...
    document.getElementById('cancel-button-ket-ktp').addEventListener('click', function() {
        const modal = document.getElementById('confirmation-modal-ket-ktp');
    ...
    document.getElementById('confirm-button-ket-ktp').addEventListener('click', function() {
        document.getElementById('createFormKeteranganKTP').submit(); // Submit the form
    });
</script>
