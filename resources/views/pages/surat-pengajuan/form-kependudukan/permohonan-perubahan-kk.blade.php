<div id="form-permohonan-perubahan-kk">
    @isset($suratEdit)
    @endisset
    <div class="intro-y mt-5 col-span-12 lg:col-span-6">
        ...
        <div class="intro-y box p-5">
            ...
            @endphp
            <form id="createFormPermohonanPerubahanKK" action="{{ route($url_form_action) }}" method="POST">
                @csrf
                ...
                <div class="card p-4 mb-4" style="background-color: #9fa8b3; color: black; border-radius: 10px">
                    ...
                    <div class="card-body">
                        <div class="grid grid-cols-2 gap-4 mt-3">
                            ...
                            <!-- Kelurahan -->
                            <div>
                                <x-base.form-label for="form-kel-permohonan-perubahan-kk">Kelurahan/Desa <span
                                        class="text-red-500">*</span></x-base.form-label>
                                <x-base.form-select class="sm:mr-2" id="form-kel-permohonan-perubahan-kk"
                            ...
                            <!-- Kecamatan -->
                            <div>
                                <x-base.form-label for="form-kec-permohonan-perubahan-kk">Kecamatan <span
                                        class="text-red-500">*</span></x-base.form-label>
                                <x-base.form-select class="sm:mr-2" id="form-kec-permohonan-perubahan-kk"
                ...
                <div class="mt-5 text-right">
                    ...
                    <x-base.button id="save-button-permohonan-perubahan-kk" class="w-24 text-white" type="button"
                        variant="success">
                        Simpan
                    </x-base.button>
                </div>
...
<div id="confirmation-modal-permohonan-perubahan-kk" aria-hidden="true" tabindex="-1"
    ...
    <div
        ...
        <div class="px-5 pb-8 text-center flex justify-center space-x-2">
            <x-base.button id="cancel-button-permohonan-perubahan-kk" class="w-full px-4 py-3" variant="soft-dark"
                type="button">
                Periksa Kembali
            </x-base.button>
            <x-base.button id="confirm-button-permohonan-perubahan-kk" class="w-full px-4 py-3 text-white"
...
<script>
    ...
    const formSelectKecPermohonanPerubahanKK = document.getElementById('form-kec-permohonan-perubahan-kk')
    const formSelectKelPermohonanPerubahanKK = document.getElementById('form-kel-permohonan-perubahan-kk')

    formSelectKecPermohonanPerubahanKK.addEventListener("change", function() {
        var selectedKec = this.value; // Get the value of the selected kecamatan
        var kelOptions = document.querySelectorAll(
            "#form-kel-permohonan-perubahan-kk option.data-kel"); // Select all options in kelurahan
        ...
        formSelectKelPermohonanPerubahanKK.value = ''
        formSelectKelPermohonanPerubahanKK.dispatchEvent(new Event('change'));
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (isadmin != 'true') {
            console.log('keganti')
            formSelectKecPermohonanPerubahanKK.value = `{{ $user->id_kec }}`;
            formSelectKecPermohonanPerubahanKK.dispatchEvent(new Event('change'));
            formSelectKelPermohonanPerubahanKK.value = `{{ $user->id_kel }}`;
            formSelectKelPermohonanPerubahanKK.dispatchEvent(new Event('change'));
        }
    })

    document.getElementById('save-button-permohonan-perubahan-kk').addEventListener('click', function(event) {
        event.preventDefault(); // Prevent the form from submitting

        const form = document.getElementById('createFormPermohonanPerubahanKK');

        if (form.checkValidity()) {
            // Form is valid, show the modal
            const modal = document.getElementById('confirmation-modal-permohonan-perubahan-kk');
    ...
    document.getElementById('cancel-button-permohonan-perubahan-kk').addEventListener('click', function() {
        const modal = document.getElementById('confirmation-modal-permohonan-perubahan-kk');
    ...
    document.getElementById('confirm-button-permohonan-perubahan-kk').addEventListener('click', function() {
        document.getElementById('createFormPermohonanPerubahanKK').submit(); // Submit the form
    });
</script>
