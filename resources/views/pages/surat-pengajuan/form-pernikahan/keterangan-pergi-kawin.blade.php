<div id="form-keterangan-pergi-kawin">
    @isset($suratEdit)
    @endisset
    <div class="intro-y mt-5 col-span-12 lg:col-span-6">
        ...
        <div class="intro-y box p-5">
            ...
            @endphp
            <form id="createFormKeteranganPergiWaliHakim" action="{{ route($url_form_action) }}" method="POST">
                @csrf
                ...
                @php
                    ...
                    $form_form_tujuan = ''; // INI BUAT CONTOH YANG BELUM ADA VALUENYA
                    ...
                    if (isset($suratEdit)) {
                        ...
                        $form_form_tujuan = $suratEdit->form_tujuan;
                ...
                <div class="card p-4 mb-4" style="background-color: #9fa8b3; color: black; border-radius: 10px">
                    ...
                    <div class="card-body">
                        <div class="grid grid-cols-2 gap-4 mt-3">
                            ...
                            <!-- Tempat Lahir -->
                            <div>
                                <x-base.form-label for="crud-form-7">Tempat Lahir <span
                                        class="text-red-500">*</span></x-base.form-label>
                            ...
                            <!-- Kelurahan -->
                            <div>
                                <x-base.form-label for="form-kel-keterangan-pergi-kawin">Kelurahan/Desa <span
                                        class="text-red-500">*</span></x-base.form-label>
                                <x-base.form-select class="sm:mr-2" id="form-kel-keterangan-pergi-kawin"
                            ...
                            <!-- Kecamatan -->
                            <div>
                                <x-base.form-label for="form-kec-keterangan-pergi-kawin">Kecamatan <span
                                        class="text-red-500">*</span></x-base.form-label>
                                <x-base.form-select class="sm:mr-2" id="form-kec-keterangan-pergi-kawin"
                ...
                <div class="card p-4 mb-4 mt-3" style="background-color: #bec0c3; color: black; border-radius: 10px">
                    ...
                    <div class="card-body">
                        <div class="grid grid-cols-2 gap-4 mt-3">
                            ...
                            <!-- Tujuan -->
                            <div>
                                <x-base.form-label for="crud-form-10">Tujuan <span
                                        class="text-red-500">*</span></x-base.form-label>
                                <x-base.form-textarea class="w-full" id="crud-form-10" placeholder="Tujuan"
                                    name="form_tujuan" required>{{ $form_form_tujuan }}</x-base.form-textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-5 text-right">
                    ...
                    <x-base.button id="save-button-ket-pergi-kawin" class="w-24 text-white" type="button"
                        variant="success">
                        Simpan
                    </x-base.button>
                </div>
...
<div id="confirmation-modal-ket-pergi-kawin" aria-hidden="true" tabindex="-1"
    ...
    <div
        ...
        <div class="px-5 pb-8 text-center flex justify-center space-x-2">
            <x-base.button id="cancel-button-ket-pergi-kawin" class="w-full px-4 py-3" variant="soft-dark"
                type="button">
                Periksa Kembali
            </x-base.button>
            <x-base.button id="confirm-button-ket-pergi-kawin" class="w-full px-4 py-3 text-white" variant="success"
                type="button">
                Simpan
            </x-base.button>
        </div>
...
<script>
    ...
    const formSelectKecKeteranganPergiKawin = document.getElementById('form-kec-keterangan-pergi-kawin')
    const formSelectKelKeteranganPergiKawin = document.getElementById('form-kel-keterangan-pergi-kawin')

    formSelectKecKeteranganPergiKawin.addEventListener("change", function() {
        var selectedKec = this.value; // Get the value of the selected kecamatan
        var kelOptions = document.querySelectorAll(
            "#form-kel-keterangan-pergi-kawin option.data-kel"); // Select all options in kelurahan
        ...
        formSelectKelKeteranganPergiKawin.value = ''
        formSelectKelKeteranganPergiKawin.dispatchEvent(new Event('change'));
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (isadmin != 'true') {
            console.log('keganti')
            formSelectKecKeteranganPergiKawin.value = `{{ $user->id_kec }}`;
            formSelectKecKeteranganPergiKawin.dispatchEvent(new Event('change'));
            formSelectKelKeteranganPergiKawin.value = `{{ $user->id_kel }}`;
            formSelectKelKeteranganPergiKawin.dispatchEvent(new Event('change'));
        }
    })

    document.getElementById('save-button-ket-pergi-kawin').addEventListener('click', function(event) {
        event.preventDefault(); // Prevent the form from submitting

        const form = document.getElementById('createFormKeteranganPergiWaliHakim');

        if (form.checkValidity()) {
            // Form is valid, show the modal
            const modal = document.getElementById('confirmation-modal-ket-pergi-kawin');
    ...
    document.getElementById('cancel-button-ket-pergi-kawin').addEventListener('click', function() {
        const modal = document.getElementById('confirmation-modal-ket-pergi-kawin');
    ...
    document.getElementById('confirm-button-ket-pergi-kawin').addEventListener('click', function() {
        document.getElementById('createFormKeteranganPergiWaliHakim').submit(); // Submit the form
    });
</script>
