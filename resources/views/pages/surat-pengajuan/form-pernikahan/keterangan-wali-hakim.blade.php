<div id="form-keterangan-wali-hakim">
    @isset($suratEdit)
    @endisset
    <div class="intro-y mt-5 col-span-12 lg:col-span-6">
        ...
        <div class="intro-y box p-5">
            ...
            @endphp
            <form id="createFormKeteranganWaliHakim" action="{{ route($url_form_action) }}" method="POST">
                @csrf
                ...
                <div class="card p-4 mb-4" style="background-color: #9fa8b3; color: black; border-radius: 10px">
                    ...
                    <div class="card-body">
                        <div class="grid grid-cols-2 gap-4 mt-3">
                            ...
                            <!-- Tempat Tinggal -->
                            <div>
                                <x-base.form-label for="crud-form-9">Tempat Tinggal <span
                                        class="text-red-500">*</span></x-base.form-label>
                            ...
                            <!-- Kelurahan -->
                            <div>
                                <x-base.form-label for="form-kel-keterangan-wali-hakim">Kelurahan/Desa <span
                                        class="text-red-500">*</span></x-base.form-label>
                                <x-base.form-select class="sm:mr-2" id="form-kel-keterangan-wali-hakim"
                            ...
                            <!-- Kecamatan -->
                            <div>
                                <x-base.form-label for="form-kec-keterangan-wali-hakim">Kecamatan <span
                                        class="text-red-500">*</span></x-base.form-label>
                                <x-base.form-select class="sm:mr-2" id="form-kec-keterangan-wali-hakim"
                            ...
                            <!-- Pekerjaan -->
                            <div>
                                <x-base.form-label for="crud-form-8">Pekerjaan <span
                                        class="text-red-500">*</span></x-base.form-label>
                ...
                <div class="mt-5 text-right">
                    ...
                    <x-base.button id="save-button-ket-wali-hakim" class="w-24 text-white" type="button"
                        variant="success">
                        Simpan
                    </x-base.button>
                </div>
...
<div id="confirmation-modal-ket-wali-hakim" aria-hidden="true" tabindex="-1"
    ...
    <div
        ...
        <div class="px-5 pb-8 text-center flex justify-center space-x-2">
            <x-base.button id="cancel-button-ket-wali-hakim" class="w-full px-4 py-3" variant="soft-dark"
                type="button">
                Periksa Kembali
            </x-base.button>
            <x-base.button id="confirm-button-ket-wali-hakim" class="w-full px-4 py-3 text-white" variant="success"
                type="button">
                Simpan
            </x-base.button>
        </div>
...
<script>
    ...
    const formSelectKecKeteranganWaliHakim = document.getElementById('form-kec-keterangan-wali-hakim')
    const formSelectKelKeteranganWaliHakim = document.getElementById('form-kel-keterangan-wali-hakim')

    formSelectKecKeteranganWaliHakim.addEventListener("change", function() {
        var selectedKec = this.value; // Get the value of the selected kecamatan
        var kelOptions = document.querySelectorAll(
            "#form-kel-keterangan-wali-hakim option.data-kel"); // Select all options in kelurahan
        ...
        formSelectKelKeteranganWaliHakim.value = ''
        formSelectKelKeteranganWaliHakim.dispatchEvent(new Event('change'));
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (isadmin != 'true') {
            console.log('keganti')
            formSelectKecKeteranganWaliHakim.value = `{{ $user->id_kec }}`;
            formSelectKecKeteranganWaliHakim.dispatchEvent(new Event('change'));
            formSelectKelKeteranganWaliHakim.value = `{{ $user->id_kel }}`;
            formSelectKelKeteranganWaliHakim.dispatchEvent(new Event('change'));
        }
    })

    document.getElementById('save-button-ket-wali-hakim').addEventListener('click', function(event) {
        event.preventDefault(); // Prevent the form from submitting

        const form = document.getElementById('createFormKeteranganWaliHakim');

        if (form.checkValidity()) {
            // Form is valid, show the modal
            const modal = document.getElementById('confirmation-modal-ket-wali-hakim');
    ...
    document.getElementById('cancel-button-ket-wali-hakim').addEventListener('click', function() {
        const modal = document.getElementById('confirmation-modal-ket-wali-hakim');
    ...
    document.getElementById('confirm-button-ket-wali-hakim').addEventListener('click', function() {
        document.getElementById('createFormKeteranganWaliHakim').submit(); // Submit the form
    });
</script>
