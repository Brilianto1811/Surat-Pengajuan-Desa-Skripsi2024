...
<body>
    ...
    <div class="content">
        ...
        <p>Yang namanya tersebut di atas memang benar warga kami yang akan menikah di KUA {{ $dataSurat->nama_kec }}.
            Berhubung orang tersebut tidak memiliki Wali Nasab, kami mohon dengan hormat Bapak Kepala KUA
            {{ $dataSurat->nama_kec }} supaya berkenan menjadi Wali. </p>
