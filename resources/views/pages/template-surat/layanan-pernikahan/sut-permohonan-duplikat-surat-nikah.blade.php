...
<head>
    ...
    <title>SURAT PERMOHONAN DUPLIKAT SURAT NIKAH</title>
    <style>
        body {
...
<body>
    ...
    <div class="content">
        ...
        <p>Yang namanya tersebut di atas memang benar warga kami dan telah menikah di KUA
            {{ $dataSurat->nama_kec }} pada tanggal:
            {{ $dataSurat->form_tgl_nikah ? Carbon::parse($dataSurat->form_tgl_nikah)->translatedFormat('d F Y') : '...' }}.
            dengan seseorang yang
            bernama {{ $dataSurat->form_nama_pasangan }}. Berdasarkan data di atas mohon untuk dibuatkan Duplikat Surat
            Nikah orang tersebut di atas.</p>
        <p>Demikian surat permohonan duplikat surat nikah ini dibuat dengan sebenarnya, untuk dipergunakan sebagaimana
            mestinya.</p>
    </div>
    <div class="footer">
