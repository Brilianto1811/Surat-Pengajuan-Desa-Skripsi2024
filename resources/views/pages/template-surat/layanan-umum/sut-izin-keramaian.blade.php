...
<body>
    ...
    <div class="header">
        ...
        <div class="header-text">
            <p>PEMERINTAH KABUPATEN BOGOR<br>KECAMATAN <span
                    class="uppercase">{{ $dataSurat->nama_kec ?? '...' }}</span><br>DESA
    ...
    <div class="content">
        ...
        <table>
            ...
            <tr>
                <td>13</td>
                <td>Keperluan</td>
                <td>: Sebagai pengantar untuk mendapatkan Surat Izin Keramaian berupa
                    {{ $dataSurat->form_jenis_keramaian ?? '...' }} mulai tanggal
                    {{ $dataSurat->mulai_berlaku ? Carbon::parse($dataSurat->mulai_berlaku)->translatedFormat('d F Y') : '...' }}
                    sampai
                    dengan
                    {{ $dataSurat->tgl_akhir ? Carbon::parse($dataSurat->tgl_akhir)->translatedFormat('d F Y') : '...' }}
                    dengan keperluan {{ $dataSurat->keterangan ?? '...' }}.</td>
            </tr>
        </table>
        <p>Orang tersebut adalah benar-benar warga Desa {{ $dataSurat->nama_des ?? '...' }} dengan data seperti di
            atas.</p>
