...
<head>
    ...
    <title>SURAT KETERANGAN JAMKESOS</title>
    <style>
        body {
...
<body>
    ...
    <div class="content">
        ...
        <p>Orang tersebut adalah benar-benar warga Desa {{ $dataSurat->nama_des }} dengan data seperti di atas, dari
            keluarga kurang mampu pemegang Kartu Peserta Jamkesos No. {{ $dataSurat->form_no_jamkesos }}</p>
