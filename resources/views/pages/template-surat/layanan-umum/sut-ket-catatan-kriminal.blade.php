    ...
    <div class="content">
        ...
        <table>
            ...
            <tr>
                <td>13</td>
                <td>Keperluan</td>
                <td>: Sebagai pengantar untuk mendapatkan SKCK yang akan dipergunakan untuk
                    {{ $dataSurat->keterangan ?? '...' }}</td>
            </tr>
        </table>
        <p>Orang tersebut di atas adalah benar-benar warga Desa {{ $dataSurat->nama_des ?? '...' }} dan menurut data
            kami tidak
            pernah terlibat perkara Polisi dan beradat istiadat baik.</p>
