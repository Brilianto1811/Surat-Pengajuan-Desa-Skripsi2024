...
@section('subhead')
    <title>Admin Aplikasi - Desa Digital</title>
@endsection
...
@section('subcontent')
    ...
    <div class="col-span-12 mt-8">
        <div class="intro-y col-span-12 mt-2 flex flex-wrap items-center sm:flex-nowrap">
            <x-base.button as="a" href="{{ route('admin-aplikasi.create') }}" class="mr-2 shadow-md" variant="primary">
                Tambah
            </x-base.button>
                    ...
                    <div class="overflow-x-auto">
                        <x-base.table striped>
                            ...
                            <x-base.table.tbody>
                                ...
                                @else
                                    @foreach ($dataAdminAplikasi as $data)
                                        <x-base.table.tr>
                                            <x-base.table.td class="whitespace-nowrap text-center">
                                                {{ $dataAdminAplikasi->firstItem() + $loop->index }}
                                            </x-base.table.td>
                                            <x-base.table.td class="whitespace-nowrap text-center">
                                                {{ $data->name_kec ?? '-' }}
                                            </x-base.table.td>
                                            ...
                                            <x-base.table.td class="whitespace-nowrap text-center">
                                                <div class="flex items-center justify-center">
                                                    <a class="mr-3 flex items-center text-warning"
                                                        href="{{ route('admin-aplikasi.edit', ['id_desauser' => $data['id_desauser']]) }}">
        ...
        <div class="flex justify-center mt-8">
            {{ $dataAdminAplikasi->appends(request()->input())->links('vendor.pagination.tailwind') }}
        </div>
    </div>
    <!-- BEGIN: Modal Content -->
    @foreach ($dataAdminAplikasi as $data)
            ...
            <div data-tw-merge
                ...
                <div class="px-5 pb-8 text-center flex justify-center space-x-2">
                    ...
                    <x-base.button as="a" data-tw-merge
                        href="{{ route('admin-aplikasi.proses-delete', ['id' => $data->id_desauser]) }}"
