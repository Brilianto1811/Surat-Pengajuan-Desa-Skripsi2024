...
@section('subhead')
    <title>Operator Desa - Desa Digital</title>
@endsection
...
@section('subcontent')
    ...
    <div class="col-span-12 mt-8">
        <div class="intro-y col-span-12 mt-2 flex flex-wrap items-center sm:flex-nowrap">
            <x-base.button as="a" href="{{ route('operator-desa.create') }}" class="mr-2 shadow-md" variant="primary">
                Tambah
            </x-base.button>
            ...
            <div class="mt-3 w-full sm:ml-auto sm:mt-0 sm:w-auto md:ml-0">
                <form method="GET" action="{{ route('operator-desa.index') }}">
                    ...
                    <div class="overflow-x-auto">
                        <x-base.table striped>
                            ...
                            <x-base.table.tbody>
                                ...
                                @else
                                    @foreach ($dataOperatorDesa as $data)
                                        <x-base.table.tr>
                                            <x-base.table.td class="whitespace-nowrap text-center">
                                                {{ $dataOperatorDesa->firstItem() + $loop->index }}
                                            </x-base.table.td>
                                            <x-base.table.td class="whitespace-nowrap text-center">
                                                {{ $data->name_kec ?? '-' }}
                                            </x-base.table.td>
                                            ...
                                            <x-base.table.td class="whitespace-nowrap text-center">
                                                <div class="flex items-center justify-center">
                                                    <a class="mr-3 flex items-center text-warning"
                                                        href="{{ route('operator-desa.edit', ['id_desauser' => $data['id_desauser']]) }}">
        ...
        <div class="flex justify-center mt-8">
            {{ $dataOperatorDesa->appends(request()->input())->links('vendor.pagination.tailwind') }}
        </div>
    </div>
    <!-- BEGIN: Modal Content -->
    @foreach ($dataOperatorDesa as $data)
            ...
            <div data-tw-merge
                ...
                <div class="px-5 pb-8 text-center flex justify-center space-x-2">
                    ...
                    <x-base.button as="a" data-tw-merge
                        href="{{ route('operator-desa.proses-delete', ['id' => $data->id_desauser]) }}"
