...
@section('subhead')
    <title>Tambah Data Operator Desa - Desa Digital</title>
@endsection
...
@section('subcontent')
    <h2 class="intro-y mt-5 mb-5 text-lg font-medium text-center py-2 bg-primary"
        ...
        TAMBAH DATA OPERATOR DESA
    </h2>

    <!-- BEGIN: Form Layout -->
    <div class="intro-y box p-5">
        <form action="{{ route('operator-desa.proses-add') }}" method="POST">
            @csrf
