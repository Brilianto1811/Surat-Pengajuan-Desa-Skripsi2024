...
class AppMdSuratnikahController extends Controller
{
    private $global_id_kab = 158;
    private $global_id_suratcat = 3;
    private $global_code_suratcat = 'SRT-NKH';
    private $global_name_suratcat = 'LAYANAN PERNIKAHAN';
    ...
    public function suratProsesAdd(Request $request)
    {
        ...
        $form_tujuan = $request->post('form_tujuan');
        $form_kepala_kk = $request->post('kepala_kk');
        $form_nama_pasangan = $request->post('form_nama_pasangan');
        $form_tgl_nikah = $request->post('form_tgl_nikah');
        ...
        $tblSurat->form_tujuan = $form_tujuan;
        $tblSurat->kepala_kk = $form_kepala_kk;
        $tblSurat->form_nama_pasangan = $form_nama_pasangan;
        $tblSurat->form_tgl_nikah = $form_tgl_nikah;
