...
class AppMdSuratumumController extends Controller
{
    private $global_id_kab = 158;
    private $global_id_suratcat = 1;
    ...
    public function suratProsesAdd(Request $request)
    {
        ...
        $form_gol_darah = $request->post('gol_darah');
        $form_kepala_kk = $request->post('kepala_kk');
        $form_pendidikan = $request->post('pendidikan');
        $form_jenis_keramaian = $request->post('form_jenis_keramaian');
        $form_no_jamkesos = $request->post('form_no_jamkesos');
        ...
        $tblSurat->gol_darah = $form_gol_darah;
        $tblSurat->id_status = 1;
        $tblSurat->kepala_kk = $form_kepala_kk;
        $tblSurat->pendidikan = $form_pendidikan;
        $tblSurat->form_jenis_keramaian = $form_jenis_keramaian;
        $tblSurat->form_no_jamkesos = $form_no_jamkesos;
